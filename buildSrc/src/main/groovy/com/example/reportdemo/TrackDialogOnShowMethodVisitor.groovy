 ...
 * @Version 1.0* 监听Dialog的显示
 */
class TrackDialogOnShowMethodVisitor extends AdviceAdapter {
    ...
    TrackDialogOnShowMethodVisitor(MethodVisitor mv, int access, String name, String desc, String className) {
